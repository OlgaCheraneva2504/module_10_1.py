...
result_time_1 = end_time_1 - start_time_1
print(f'Время выполнения функций:', result_time_1)
...
result_time_2 = end_time_2 - start_time_2
print(f'Время выполнения функций:', result_time_2)